...
function ProjectCard({
  ...
  return (
    ...
    >
      <div className="border-b border-white/10 bg-background/54 p-4 sm:p-5">
        <ImageFrame
          src={project.image}
          ...
          className={cn(
            "rounded-md border-0 bg-[#140d23]",
            featured ? "aspect-[4/3] min-h-72" : "aspect-[4/3] min-h-64",
          )}
          contentClassName="p-6"
          imageClassName="object-contain object-center p-8 sm:p-10"
        />
